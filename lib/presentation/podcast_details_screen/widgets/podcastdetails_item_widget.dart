...
class PodcastdetailsItemWidget extends StatelessWidget {
  ...
  var controller = Get.find<PodcastDetailsController>();
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Obx(
          () => CustomImageView(
            imagePath: podcastdetailsItemModelObj.image!.value,
        ...
        Column(
          ...
          children: [
            SizedBox(
              ...
              child: Obx(
                () => Text(
                  podcastdetailsItemModelObj.podcastTitle!.value,
                  maxLines: 2,
            ...
            Row(
              children: [
                Obx(
                  () => Text(
                    podcastdetailsItemModelObj.author!.value,
                ...
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      podcastdetailsItemModelObj.text!.value,
                      style: theme.textTheme.labelLarge,
                    ),
                  ),
                ),
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      podcastdetailsItemModelObj.time!.value,
                      style: theme.textTheme.labelLarge,
                    ),
                  ),
                ),
            ...
            SizedBox(
              ...
              child: Row(
                children: [
                  Obx(
                    () => CustomImageView(
                      imagePath: podcastdetailsItemModelObj.image1!.value,
                      height: 20.adaptSize,
                      width: 20.adaptSize,
